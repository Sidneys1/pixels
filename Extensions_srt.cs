...
namespace srt
{
    internal static class Extensions {
        ...
        static double Lerp(double first, double second, double by) => by switch {
            <= 0 => first,
            >= 1 => second,
            _ => first * (1 - by) + second * by,
        };
        ...
        public static Color Lerp(this Color first, Color second, double by) => by switch {
            <= 0 => first,
            >= 1 => second,
            _ => Color.FromRgb(
